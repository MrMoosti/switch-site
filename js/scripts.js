$(document).ready(function() {
  ...
  $("#scroll-meet-the-team").click(function() {
    $('html, body').animate({
  ...
  $("#div-meet-the-team").removeClass('button-clicked-meet-the-team');
  $("#scroll-meet-the-team").removeClass('Proxima-bold');
  ...
  $("#scroll-meet-the-team").click(function() {
    if (!$("#div-meet-the-team").hasClass('button-clicked-meet-the-team'))
      $("#div-meet-the-team").addClass('button-clicked-meet-the-team');
    $(this).addClass('Proxima-bold');
  ...
  $("#learn-more").click(function() {
    alert('Learn more! This button is functional, learn more at https://www.meyilmaz.com')
  });

  $("#demo-clients").click(function() {
    alert('All clients, this is just an demo website.')
  });
